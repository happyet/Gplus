  ...
  ajax.onreadystatechange = function () {
    if (ajax.readyState == 4 && ajax.status == 200) {
      ...
      if (versionCompare(gplusVersion, obj.tag_name) == -1) {
        container.innerHTML = "<h2>🎉 发现新版本！</h2>" + '<a href="https://github.com/happyet/Gplus/archive/refs/tags/' + obj.tag_name + '.zip" target="_blank">点击下载（' + obj.tag_name + '）</a><p>' + obj.body +'</p>';
      } else {
